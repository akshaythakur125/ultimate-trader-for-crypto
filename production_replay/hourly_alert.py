...
def run_hourly_alert() -> dict:
    ...
    try:
        ...
        pass
    # Run breadwinner backtest for fresh data (Phase 76)
    try:
        subprocess.run(
            [sys.executable, "-m", "production_replay.breadwinner_backtest"],
            capture_output=True, text=True, timeout=60,
        )
    except Exception:
        pass
    ...
    try:
        ...
        pass
    # Run derivatives edge layer for fresh data (Phase 78)
    try:
        subprocess.run(
            [sys.executable, "-m", "production_replay.derivatives_edge_layer"],
            capture_output=True, text=True, timeout=120,
        )
    except Exception:
        pass
