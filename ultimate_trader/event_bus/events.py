...
class EventType(str, Enum):
    ...
    MICROSTRUCTURE_ANALYSIS_COMPLETED = "MICROSTRUCTURE_ANALYSIS_COMPLETED"
    LIVE_TRADE_BLOCKED = "LIVE_TRADE_BLOCKED"
    INSTITUTIONAL_ORDERFLOW_COMPLETED = "INSTITUTIONAL_ORDERFLOW_COMPLETED"
    LIQUIDITY_SMART_MONEY_COMPLETED = "LIQUIDITY_SMART_MONEY_COMPLETED"
    HISTORICAL_REPLAY_STARTED = "HISTORICAL_REPLAY_STARTED"
    HISTORICAL_REPLAY_COMPLETED = "HISTORICAL_REPLAY_COMPLETED"
    REPLAY_TRADE_OPENED = "REPLAY_TRADE_OPENED"
    REPLAY_TRADE_CLOSED = "REPLAY_TRADE_CLOSED"
    REPLAY_SIGNAL_REJECTED = "REPLAY_SIGNAL_REJECTED"
